    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 print:bg-white print:text-slate-900 selection:bg-amber-500 selection:text-slate-950">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-12 print:space-y-8 print:p-0 print:max-w-none">
        ...
        <section className="print:page-break-after-always print:pt-4 border-b border-slate-800 print:border-slate-300 pb-10 print:pb-6 space-y-6">
          ...
          {/* Cosmic Essence Narrative */}
          <div className="p-5 sm:p-6 rounded-3xl bg-slate-900/60 print:bg-slate-50 border border-slate-800 print:border-slate-300 leading-relaxed text-sm text-slate-300 print:text-slate-800">
            <h3 className="font-bold text-xs uppercase tracking-wider text-amber-400 print:text-amber-800 mb-2 flex items-center gap-1.5">
              <span>🌟</span>
              <span>Your Cosmic Essence</span>
            </h3>
            <p className="font-medium text-slate-200 print:text-slate-900 leading-relaxed">
              {report.nativeProfile.cosmicEssence}
            </p>
          </div>
        </section>
